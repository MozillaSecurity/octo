...
class logger {
  ...
  static log (msg) {
    logger.dumpln(`/*L*/ ${utils.script.safely(msg)}`)
  }
  ...
  static error (msg) {
    logger.dumpln(color.red + msg + color.clear)
  }

  static ok (msg) { // eslint-disable-line no-unused-vars
    logger.dumpln(color.green + msg + color.green)
  }
  ...
  static separator () {
    logger.dumpln(color.green + sep + color.clear)
  }
